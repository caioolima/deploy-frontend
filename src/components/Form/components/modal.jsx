        ...
        >
          ...
          <form>
            <input
              type="text"
              className={
                style.entrada || style[formErrors.username && "input-error"]
              }
              id="username"
            ...
            <div className={style["flex-container"]}>
              <div className={style["flex-item"]}>
                <input
                  ...
                  className={
                    style.entrada ||
                    style[formErrors.firstName && "input-error"]
                  }
                  id="firstName"
              ...
              <div className={style["flex-item"]}>
                <input
                  type="text"
                  className={
                    style.entrada || style[formErrors.lastName && "input-error"]
                  }
                  id="lastName"
            ...
            <input
              type="email"
              className={
                style.entrada || style[formErrors.email && "input-error"]
              }
              id="email"
              placeholder={t("email")}
            ...
            {formErrors.email && (
              <p
                className={
                  style["error-message"] ||
                  style[formErrors.email && "input-error"]
                }
              >
                {formErrors.email}
              </p>
            ...
            <div className={style["password-input-container"]}>
              <input
                ...
                className={
                  style.entrada ||
                  style[formErrors.confirmPassword && "input-error"]
                }
                id="confirmPassword"
            ...
            {registrationMessage && (
              <p className={style["registration-message"]}>
                {registrationMessage}
              </p>
            )}
          </form>
