...
const ResetPassword = ({ onClose }) => {
  ...
  const resetPassword = async (e) => {
    ...
    try {
      const response = await fetch("https://server-repository.onrender.com/auth/requestPasswordReset", {
        method: "POST",
        headers: {
  ...
  const verifyCode = async () => {
    ...
    try {
      const response = await fetch("https://server-repository.onrender.com/auth/verifyCode", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://server-repository.onrender.com/auth/resetPassword/${code.join(
          ""
        )}`,
        {
          method: "POST",
