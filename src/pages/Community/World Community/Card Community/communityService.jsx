...
export const fetchComunidades = async () => {
  try {
    const response = await fetch("https://server-repository.onrender.com/communities/comunidade/listar");
...
export const fetchNumeroMembros = async (communityId) => {
  try {
    const response = await fetch(`https://server-repository.onrender.com/communities/comunidade/contarMembros/${communityId}`);
    const data = await response.json();
...
export const fetchTopFollowedUsers = async () => {
  try {
    const response = await fetch("https://server-repository.onrender.com/user/top-followed");
    const data = await response.json();
...
export const fetchTopLikedPosts = async () => {
  try {
    ...
    const response = await fetch("https://server-repository.onrender.com/gallery/top-liked", {
      headers: {
...
export async function fetchComunidadesDoUsuario(userId) {
  try {
    const response = await fetch(`https://server-repository.onrender.com/communities/comunidade/obterComunidadesDoUsuario/${userId}`);
    if (!response.ok) {
