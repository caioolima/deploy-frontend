...
const CreateCommunityModal = () => {
  ...
  const verificarExistenciaComunidade = async (nomeComunidade) => {
    try {
      const response = await fetch(
        `https://server-repository.onrender.com/communities/comunidade/verificarExistencia/${encodeURIComponent(
          nomeComunidade
        )}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://server-repository.onrender.com/communities/comunidade/criar/" +
